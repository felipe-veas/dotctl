...
Status: completed for the current MVP. Restore requires `--force` unless `--dry-run`; directory restore fidelity remains constrained by the existing backup layout.
